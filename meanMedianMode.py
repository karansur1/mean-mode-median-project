...
def show_mean(total_weight, total_entries):
    mean = total_weight / total_entries
    print(f"Mean (Average) is -> {mean:2f}")

def show_median(total_entries, sorted_data):
...
show_mean(total_weight, total_entries)
show_median(total_entries, sorted_data)
show_mode(sorted_data)